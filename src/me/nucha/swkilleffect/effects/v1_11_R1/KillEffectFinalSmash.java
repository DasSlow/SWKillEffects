package me.nucha.swkilleffect.effects.v1_11_R1;
...
public class KillEffectFinalSmash extends KillEffect {
	...
	public void play(Player p) {
		...
		net.minecraft.server.v1_11_R1.ItemStack nmsChest = CraftItemStack.asNMSCopy(chest);
		net.minecraft.server.v1_11_R1.ItemStack nmsLeg = CraftItemStack.asNMSCopy(leg);
		net.minecraft.server.v1_11_R1.ItemStack nmsBoots = CraftItemStack.asNMSCopy(boots);
