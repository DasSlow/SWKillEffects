package me.nucha.swkilleffect.effects.v1_8_R2;
...
public class KillEffectFinalSmash extends KillEffect {
	...
	public void play(Player p) {
		...
		net.minecraft.server.v1_8_R2.ItemStack nmsSkull = CraftItemStack.asNMSCopy(skull);
		net.minecraft.server.v1_8_R2.ItemStack nmsChest = CraftItemStack.asNMSCopy(chest);
		net.minecraft.server.v1_8_R2.ItemStack nmsLeg = CraftItemStack.asNMSCopy(leg);
		net.minecraft.server.v1_8_R2.ItemStack nmsBoots = CraftItemStack.asNMSCopy(boots);
